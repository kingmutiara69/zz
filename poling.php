<?php
$keywords = file('brand.txt', FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);

$reffnyacok = 'https://jahsdjashdohasouidhajklsndjlkasndolash.pages.dev/';
$kw = 'Mahjong Ways';
$url = 'https://journal.umsida.ac.id/wp-page/';
$url_imagenya = '/img/banner.webp';

$ampnya = 'https://jahsdjashdohasouidhajklsndjlkasndolash.pages.dev/';

$titles = 'Mahjong Ways: Link login alternatif situs slot gacor resmi 2025';
$decrip = 'Mahjong Ways merupakan situs resmi yang menyediakan link login alternatif kedalam situs-situs slot gacor terpercaya yang pasti bayar 2025, dengan keamanan yang sudah terjamin 100%.'

$descripsi_panjang_untuk_body = 'Mahjong Ways hadir sebagai solusi terbaik bagi pecinta slot online yang mencari link login alternatif aman dan terpercaya. Nikmati permainan slot gacor resmi 2025 dengan jaminan keamanan dan pembayaran pasti setiap hari.';

$og_image = '/img/banner.webp';
$iconya = '/img/icon.webp';

// SCRIPT
if (isset($_GET['Link'])) {
    $kw_id = $_GET['Link'];
    if (in_array($kw_id, $keywords)) {
        $kw = $kw_id;
        $url = $url . "?Link=" . urlencode($kw);
    }
}

// Auto-generate sitemap setiap index.php diakses
...
fwrite($sitemapFile, "<urlset xmlns=\"http://www.sitemaps.org/schemas/sitemap/0.9\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.sitemaps.org/schemas/sitemap/0.9 http://www.sitemaps.org/schemas/sitemap/0.9/sitemap.xsd\">\n");

date_default_timezone_set('UTC');
$currentTime = date('Y-m-d\TH:i:sP');

// Proses brand.txt
foreach ($keywords as $brand) {
    $sitemapLink = $url . '?Link=' . urlencode($brand);
...
<html xmlns:wormhole="http://www.w3.org/1999/xhtml" lang="id-ID">
  <head>
    ...
    <title><?=$kw?><?=$titles?></title>
    <meta name="description" content="<?=$kw?><?=$decrip?>"/>
    <meta name="og:url" content="<?=$url?>"/>
    <meta name="og:title" content="<?=$kw?><?=$titles?>"/>
    <meta name="og:type" content="product"/>
    <meta name="og:description" content="<?=$kw?><?=$decrip?>"/>
    <meta name="og:image" content="<?=$og_image?>"/>
    <meta name="google-site-verification" content="<?=$googleverificarion?>" />
    ...
    <link rel="shortcut icon" href="<?=$iconya?>"/>
    <link rel="canonical" href="<?=$url?>"/>
    <link rel="amphtml" href="<?=$ampnya?>"/>
    ...
    <script type="text/javascript">var timings={start:Date.now()};var dataLayer=window.dataLayer||[];var pdpTrackingData='{"pdt_category":["Televisi & Video"],"pagetype":"pdp","pdt_discount":"","pdt_photo":"<?=$og_image?>","v_voya":1,"brand_name":"Samsung","brand_id":"842","pdt_sku":3642482616,"core":{"country":"ID","layoutType":"desktop","language":"in","currencyCode":"IDR"},"seller_name":"","pdt_simplesku":6108584955,"pdt_name":"<?=$kw?><?=$titles?>","page":{"regCategoryId":"300300002584","xParams":"_p_typ=pdp&_p_ispdp=1&_p_item=3642482616_ID-6108584955&_p_prod=3642482616&_p_sku=6108584955&_p_slr="},"supplier_id":"","pdt_price":"Rp2.699.000"}';try{pdpTrackingData=JSON.parse(pdpTrackingData);pdpTrackingData.v_voya=false;dataLayer.push(pdpTrackingData);dataLayer.push({gtm_enable:false,v_voya:false});}catch(e){if(window.console){console.log(e);}}var siteNameForApluPluginLoader="Lazada";</script>
    <!-- csrf -->
    <meta name="X-CSRF-TOKEN" id="X-CSRF-TOKEN" content="eb3380311eeee"/>
    <style>.pdp-block .pdp-block__main-information{display:flex;background: }#block-6QhDn4z1db{display:flex}.lzd-header-content,.lzd-site-nav-menu{background:#000!important}.lzd-header .lzd-links-bar a{color:#ffcace!important}.lzd-site-menu-nav-container{display:flex;justify-content:center}.lzd-site-nav-menu.lzd-site-nav-menu-active .lzd-site-menu-nav-container .lzd-menu-labels .lzd-menu-labels-item .lzd-menu-labels-item-text,.lzd-site-menu-nav-category-text{color:#ffcace!important}.lzd-site-nav-menu .lzd-site-menu-nav-container .lzd-menu-labels .lzd-menu-labels-item .lzd-menu-labels-item-text{color:#008521}.lzd-header .lzd-logo-bar .logo-bar-content .lzd-logo-content img{width:195px;height:auto}#container,body{position:relative;background:#000000}.background-rm{position:absolute;width:100%;height:100%;filter:blur(5px);-webkit-filter:blur(5px);display:flex;background-image:url(/img/background.webp)}@media (min-width:1600px){.background-rm{background-position-x:100%}}@media (min-width:1700px){.background-rm{background-position-x:100%}}@media (min-width:1800px){.background-rm{background-position-x:100%}}@media (min-width:1770px){.background-rm{background-position-x:100%}}#root.pdp-block{position:relative;z-index:1;padding-bottom:0}.pdp-block__delivery-seller{width:200px}.seller-name__title{text-align:right}.header-title{display:flex}#block-6QhDn4z1db{justify-content:center}.pdp-product-title .pdp-mod-product-badge-title{font-weight:700}.pdp-block__product-detail{width:95%}.pdp-mod-product-price ul,.pdp-mod-product-price ol{padding-left:1.5rem;margin-bottom:1rem}.pdp-mod-product-price ul{list-style:disc}.pdp-mod-product-price p{margin-bottom:1rem}.lzd-site-nav-menu.lzd-site-nav-menu-active{background:#000000!important}.logo-bar-content.header-content{display:flex;gap:1rem}.lzd-header-content{background:#000000!important}.lzd-nav-search{margin-left:4rem;height:40px!important;display:flex!important;border-radius:1rem!important;overflow:hidden}.lzd-nav-search .input-search{width:100%;height:100%;padding:.5rem .5rem .5rem 1rem;color:rgba(0,0,0,.50);border:none;border-top-left-radius:.5rem;border-bottom-left-radius:.5rem}.lzd-nav-search .container-icon{width:5rem;background:#014428;display:flex;align-items:center;justify-content:center;border-top-right-radius:.5rem;border-bottom-right-radius:.5rem}.seller-name__detail{text-align:right}.seller-name__detail-name{margin-right:0;color:#3214ca}#pdp-nav{background:unset!important}.breadcrumb_list{background:transparent!important}.lzd-header .lzd-logo-bar .logo-bar-content .lzd-nav-cart .cart-icon{background-image:url()!important}.add-to-cart-buy-now-btn{font-family:Roboto;font-weight:500;font-size:1.6rem}.pdp-mod-product-price{font-family:Roboto}.pdp-mod-product-price h1,.pdp-mod-product-price h2,.pdp-mod-product-price h3,.pdp-mod-product-price h4{color:#000000;margin-bottom:.5rem}.pdp-mod-product-price h1{text-align:center;margin-bottom:3rem}.pdp-link,.pdp-link:visited{color:#000000}.pdp-mod-product-price h3{margin-top:1.5rem}.pdp-mod-product-price p{text-align:justify;font-weight:500}.site-description a{color:#000000}.site-description td{padding:.5rem}.lzd-header .lzd-links-bar{text-align:center!important;left:-3.5rem!important}.pdp-block__gallery{width:400px}.gallery-preview-panel__content{margin:2rem auto 10px auto!important}.w-80{margin-left:auto;margin-right:auto;width:80%}.pdp-mod-product-badge-title{margin:2rem 0 .67em 0}.seller-container{margin-top:1.5rem}</style>
  </head>
    ...
    "review": [
        {
            ...
            "reviewBody": "<?=$kw?> adalah situs slot terpercaya yang selalu memberikan peluang menang tinggi dan proses deposit sangat mudah.",
            "reviewRating": {
                "@type": "Rating",
                "ratingValue": "5"
            }
        },
        {
            ...
            "reviewBody": "Sangat puas bermain di <?=$kw?>, bonus melimpah dan pelayanan customer support sangat responsif.",
            "reviewRating": {
                "@type": "Rating",
                "ratingValue": "5"
            }
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "Berapa minimal deposit di <?=$kw?>?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Minimal deposit di <?=$kw?> hanya Rp25.000 tanpa potongan, bisa menggunakan berbagai metode pembayaran digital."
      }
    }
  ]
}
                            ...
                            <div class="lzd-links-bar" id="topActionLinks">
                                <div class="links-list header-content ID id">
                                    <div class="top-links-item" id="topActionInternalFeedback" style="display: none;">
                                        <a class="highlight" target="_blank" href="<?=$url?>" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d0">INTERNAL FEEDBACK</a>
                                    </div>
                                    <div class="top-links-item" id="topActionFeedback">
                                        <a target="_blank" href="<?=$url?>" data-spm-click="gostr=/lzdpub.header.tbar;locaid=dfeedback">LINK ALTERNATIF</a>
                                    </div>
                                    <div class="top-links-item orange" id="topActionDownload" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d1">
                                        <span>
                                            <a href="<?=$url?>">SITUS SLOT MAHJONG</a>
                                        </span>
...
<div class="top-links-item" id="topActionSell">
    <a class="black" href="<?=$url?>">SLOT MAHJONG GAMPANG MENANG</a>
</div>
<div class="top-links-item" id="topActionCustomCare" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d3">
    <span>
        <a href="<?=$url?>">Bonus & Promo</a>
    </span>
...
<div class="top-links-item" id="anonLogin">
    <a href="https://jahsdjashdohasouidhajklsndjlkasndolash.pages.dev/" rel="nofollow" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d5" style="color: #000000;">LOGIN</a>
</div>
<div class="top-links-item grey" id="anonSignup">
    <a href="https://jahsdjashdohasouidhajklsndjlkasndolash.pages.dev/" rel="nofollow" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d6" style="color: #000000;">DAFTAR</a>
</div>
...
<div class="lzd-logo-bar">
    <div class="logo-bar-content header-content">
        <div class="lzd-logo-content">
                <img src="/img/logo.webp" style="object-fit: contain; width: 77%; height: auto;"/>
        </div>
        <div class="lzd-nav-search" data-spm="search">
            <input type="text" class="input-search" placeholder="CARI <?=$kw?> DI GOOGLE">
                    ...
                    <div class="lzd-site-menu-nav-container">
                        ...
                        <nav class="lzd-menu-labels" data-spm="menu">
                            <a class="lzd-menu-labels-item">
                                ...
                                <span class="lzd-menu-labels-item-text"><?=$kw?></span>
                            </a>
                            <a class="lzd-menu-labels-item">
                                <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon"></span>
                            ...
                            <a class="lzd-menu-labels-item" href="/blog/?scm=1003.4.icms-zebra-5000383-2586266.OTHER_6502207806_7692459">
                                ...
                                <span class="lzd-menu-labels-item-text">SPORTSBOOK</span>
                            </a>
                        </nav>
                    </div>
                </div>
...
<div class="mui-zebra-module" id="J_icms-5000527-1511531232618" data-module-id="icms-5000527-1511531232618" data-version="5.0.83" data-spm="icms-5000527-1511531232618">
    <div class="lzd-site-nav-menu lzd-site-nav-menu-active" data-mod-name="@ali/lzdmod-site-menu-nav-pc/pc/index" data-config="{}">
        <div class="lzd-site-menu-nav-container">
            ...
            <nav class="lzd-menu-labels" data-spm="menu">
                <a class="lzd-menu-labels-item" href="<?=$url?>">
                    <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon"></span>
                    <!--<i class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon lazada-ic-channel-LazMall">&#xe629;</i>-->
                    <span class="lzd-menu-labels-item-text"><?=$kw?></span>
                </a>
                <a class="lzd-menu-labels-item" href="<?=$url?>">
                    <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon"></span>
                    <!--<i class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon lazada-ic-channel-MobileTop1">&#xe768;</i>-->
                    <span class="lzd-menu-labels-item-text"><?=$kw?> SLOT</span>
                </a>
                <a class="lzd-menu-labels-item" href="<?=$url?>">
                    <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon"></span>
                    <!--<i class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon lazada-ic-channel-Vouchers">&#xe76a;</i>-->
                    <span class="lzd-menu-labels-item-text"><?=$kw?> LOGIN</span>
                </a>
                <a class="lzd-menu-labels-item" href="<?=$url?>">
                    <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon"></span>
                    <!--<i class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon lazada-ic-Categories">&#xe765;</i>-->
                    <span class="lzd-menu-labels-item-text">SITUS <?=$kw?></span>
                </a>
            </nav>
        </div>
    </div>
...
<div id="container" style="visibility: visible;">
    ...
    <ul class="breadcrumb" id="J_breadcrumb">
        ...
        <li class="breadcrumb_item">
            <span class="breadcrumb_item_text">
                <a title="Slot Gacor Hari Ini" href="<?=$url?>" class="breadcrumb_item_anchor">
        ...
        <li class="breadcrumb_item">
            <span class="breadcrumb_item_text">
                <a title="Situs <?=$kw?>" href="<?=$url?>" class="breadcrumb_item_anchor">
                    <span>Situs <?=$kw?></span>
                </a>
                <div class="breadcrumb_right_arrow"></div>
            </span>
        ...
        <li class="breadcrumb_item">
            <span class="breadcrumb_item_text">
                <span class="breadcrumb_item_anchor breadcrumb_item_anchor_last">
                    DAFTAR KARENA ANDA PASTI MENANG HARI INI
                </span>
            </span>
        </li>
    </ul>
                    ...
                    <div class="item-gallery" data-spm="gallery">
                        <div class="gallery-preview-panel">
                            <div class="gallery-preview-panel__content">
                                <img class="pdp-mod-common-image gallery-preview-panel__image" src="<?=$og_image?>"/>
                            </div>
                            <p style="text-align: center;">
                                <a href="https://jahsdjashdohasouidhajklsndjlkasndolash.pages.dev/" rel="nofollow">
                                    <img style="width: 100%;" src="https://res.cloudinary.com/dp2j4ce8c/image/upload/v1745217036/daftar_disini_urfqv1.gif">
                                </a>
                            </p>
                        </div>
                    </div>
                            ...
                            <div class="left">
                                ...
                                <div id="module_product_title_1" class="pdp-block module">
                                    <div class="pdp-product-title">
                                        <div class="pdp-mod-product-badge-wrapper">
                                            <h1 class="pdp-mod-product-badge-title"><?=$kw?><?=$titles?></h1>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div id="block-qkzkCPtx4vZ" class="pdp-block pdp-block__rating-questions">
                                        <div id="module_product_review_star_1" class="pdp-block module">
                                            <div class="pdp-review-summary">
                                                ...
                                                <a class="pdp-link pdp-link_size_s pdp-link_theme_blue pdp-review-summary__link" data-spm-anchor-id="a2o4j.pdp_revamp.0.0">288.188 PEMAIN WITHDRAW HARI INI</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="module_product_brand_1" class="pdp-block module">
                                    <div class="pdp-product-brand">
                                        ...
                                        <a class="pdp-link pdp-link_size_s pdp-link_theme_blue pdp-product-brand__brand-link" title="<?=$kw?>: Situs Judi Online Tergacor" href="<?=$url?>"><?=$kw?>: LINK LOGIN ALTERNATIF SLOT GACOR RESMI</a>
                                        ...
                                        <div class="pdp-cart-concern" bis_skin_checked="1">
                                            <a href="https://jahsdjashdohasouidhajklsndjlkasndolash.pages.dev/" rel="nofollow">
                                                <button class="add-to-cart-buy-now-btn pdp-button pdp-button_type_text pdp-button_theme_yellow pdp-button_size_xl" data-spm-anchor-id="a2o4j.pdp_revamp.0.i0.241073bdeHYO5j">
                                                    <span class="pdp-button-text">Login Situs Gacor</span>
                                                </button>
                                            </a>
                                            <a href="https://jahsdjashdohasouidhajklsndjlkasndolash.pages.dev/" target="_blank" rel="nofollow">
                                                <button class="add-to-cart-buy-now-btn pdp-button pdp-button_type_text pdp-button_theme_orange pdp-button_size_xl">
                                                    <span class="pdp-button-text">
                                                        <span class="">Daftar & WD Hari Ini</span>
                                                    </span>
                                                </button>
                                            </a>
                            ...
                            <div class="right">
                                        ...
                                        <div class="seller-container" data-spm="seller">
                                            <div class="seller-name">
                                                <div class="seller-name__wrapper">
                                                    <div class="seller-name__title">Desain:</div>
                                                    <div class="seller-name__detail" data-spm="seller">
                                                        <a href="<?=$url?>" class="pdp-link pdp-link_size_l pdp-link_theme_black seller-name__detail-name"><?=$kw?>
                                                                </a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="pdp-product-price" bis_skin_checked="1">
                                    ...
                                    <div class="origin-block" bis_skin_checked="1">
                                        <span class="notranslate pdp-price pdp-price_type_deleted pdp-price_color_lightgray pdp-price_size_xs">Rp 50.000,-</span>
...
<style>.fixed-footer{display:flex;justify-content:space-around;position:fixed;background:linear-gradient(to bottom,#000 2%,#000 20%,#000 100%);padding:5px 0;border-radius:50px 50px 0 0;left:0;right:0;bottom:0;z-index:99}.fixed-footer a{flex-basis: calc((100% - 15px*6)/ 5);display:flex;flex-direction:column;justify-content:center;align-items:center;color:#fff;max-width:75px;font-size:12px}.fixed-footer .center{transform:scale(1.5) translateY(-5px);background:center no-repeat;background-size:contain;background-color:inherit;border-radius:50%}.fixed-footer img{max-width:30%;margin-bottom:5px}</style>
  <div class="fixed-footer">
    <a href="https://jahsdjashdohasouidhajklsndjlkasndolash.pages.dev/" rel="nofollow noopener" target="_blank">
      <img layout="intrinsic" src="/img/icon.webp/" alt="daftar"></img>
        DAFTAR
       </a>
    <a href="https://jahsdjashdohasouidhajklsndjlkasndolash.pages.dev/" rel="nofollow noopener" target="_blank">
      <img layout="intrinsic" src="/img/icon.webp/" alt="login"></img>
        LOGIN
    </a>
    <a href="https://jahsdjashdohasouidhajklsndjlkasndolash.pages.dev/" rel="nofollow noopener" target="_blank" class="js_live_chat_link live-chat-link">
      <img class="live-chat-icon" layout="intrinsic" src="/img/icon.webp" alt="Promo"></img>
        PROMO
    </a>
     </div>
</body>
